...
public enum SkillPerk {
    ...
    ALTERATION_NOVICE_ALTERATION(SkillProgression.Skill.ALTERATION, "Novice Alteration", req(0)),
    ALTERATION_ALTERATION_DUAL_CASTING(SkillProgression.Skill.ALTERATION, "Alteration Dual Casting", req(20),
            "alteration_novice_alteration"),
    ALTERATION_APPRENTICE_ALTERATION(SkillProgression.Skill.ALTERATION, "Apprentice Alteration", req(25),
            "alteration_novice_alteration"),
    ALTERATION_MAGIC_RESISTANCE(SkillProgression.Skill.ALTERATION, "Magic Resistance", req(30, 50, 70),
            "alteration_apprentice_alteration"),
    ALTERATION_ADEPT_ALTERATION(SkillProgression.Skill.ALTERATION, "Adept Alteration", req(50),
            "alteration_apprentice_alteration"),
    ALTERATION_EXPERT_ALTERATION(SkillProgression.Skill.ALTERATION, "Expert Alteration", req(75),
            "alteration_adept_alteration"),
    ALTERATION_ATRONACH(SkillProgression.Skill.ALTERATION, "Atronach", req(100),
            "alteration_expert_alteration"),
    ALTERATION_MASTER_ALTERATION(SkillProgression.Skill.ALTERATION, "Master Alteration", req(100),
            "alteration_expert_alteration"),
    ALTERATION_STABILITY(SkillProgression.Skill.ALTERATION, "Stability", req(70),
            "alteration_adept_alteration"),
    ALTERATION_MAGE_ARMOR(SkillProgression.Skill.ALTERATION, "Mage Armor", req(30, 50, 70),
            "alteration_apprentice_alteration"),

    CONJURATION_NOVICE_CONJURATION(SkillProgression.Skill.CONJURATION, "Novice Conjuration", req(0)),
    CONJURATION_APPRENTICE_CONJURATION(SkillProgression.Skill.CONJURATION, "Apprentice Conjuration", req(25),
            "conjuration_novice_conjuration"),
    CONJURATION_ADEPT_CONJURATION(SkillProgression.Skill.CONJURATION, "Adept Conjuration", req(50),
            "conjuration_apprentice_conjuration"),
    CONJURATION_EXPERT_CONJURATION(SkillProgression.Skill.CONJURATION, "Expert Conjuration", req(75),
            "conjuration_adept_conjuration"),
    CONJURATION_MASTER_CONJURATION(SkillProgression.Skill.CONJURATION, "Master Conjuration", req(100),
            "conjuration_expert_conjuration"),
    CONJURATION_CONJURATION_DUAL_CASTING(SkillProgression.Skill.CONJURATION, "Conjuration Dual Casting", req(20),
            "conjuration_novice_conjuration"),
    CONJURATION_MYSTIC_BINDING(SkillProgression.Skill.CONJURATION, "Mystic Binding", req(20),
            "conjuration_novice_conjuration"),
    CONJURATION_SOUL_STEALER(SkillProgression.Skill.CONJURATION, "Soul Stealer", req(30),
            "conjuration_mystic_binding"),
    CONJURATION_OBLIVION_BINDING(SkillProgression.Skill.CONJURATION, "Oblivion Binding", req(50),
            "conjuration_soul_stealer"),
    CONJURATION_NECROMANCY(SkillProgression.Skill.CONJURATION, "Necromancy", req(40),
            "conjuration_novice_conjuration"),
    CONJURATION_DARK_SOULS(SkillProgression.Skill.CONJURATION, "Dark Souls", req(70),
            "conjuration_necromancy"),
    CONJURATION_SUMMONER(SkillProgression.Skill.CONJURATION, "Summoner", req(30, 70),
            "conjuration_novice_conjuration"),
    CONJURATION_ATROMANCY(SkillProgression.Skill.CONJURATION, "Atromancy", req(40),
            "conjuration_summoner"),
    CONJURATION_ELEMENTAL_POTENCY(SkillProgression.Skill.CONJURATION, "Elemental Potency", req(80),
            "conjuration_atromancy"),
    CONJURATION_TWIN_SOULS(SkillProgression.Skill.CONJURATION, "Twin Souls", req(100),
            "conjuration_dark_souls", "conjuration_elemental_potency"),

    DESTRUCTION_NOVICE_DESTRUCTION(SkillProgression.Skill.DESTRUCTION, "Novice Destruction", req(0)),
    DESTRUCTION_APPRENTICE_DESTRUCTION(SkillProgression.Skill.DESTRUCTION, "Apprentice Destruction", req(25),
            "destruction_novice_destruction"),
    DESTRUCTION_ADEPT_DESTRUCTION(SkillProgression.Skill.DESTRUCTION, "Adept Destruction", req(50),
            "destruction_apprentice_destruction"),
    DESTRUCTION_EXPERT_DESTRUCTION(SkillProgression.Skill.DESTRUCTION, "Expert Destruction", req(75),
            "destruction_adept_destruction"),
    DESTRUCTION_MASTER_DESTRUCTION(SkillProgression.Skill.DESTRUCTION, "Master Destruction", req(100),
            "destruction_expert_destruction"),
    DESTRUCTION_RUNE_MASTER(SkillProgression.Skill.DESTRUCTION, "Rune Master", req(40),
            "destruction_apprentice_destruction"),
    DESTRUCTION_AUGMENTED_FLAMES(SkillProgression.Skill.DESTRUCTION, "Augmented Flames", req(30, 60),
            "destruction_novice_destruction"),
    DESTRUCTION_INTENSE_FLAMES(SkillProgression.Skill.DESTRUCTION, "Intense Flames", req(50),
            "destruction_augmented_flames"),
    DESTRUCTION_AUGMENTED_FROST(SkillProgression.Skill.DESTRUCTION, "Augmented Frost", req(30, 60),
            "destruction_novice_destruction"),
    DESTRUCTION_DEEP_FREEZE(SkillProgression.Skill.DESTRUCTION, "Deep Freeze", req(60),
            "destruction_augmented_frost"),
    DESTRUCTION_AUGMENTED_SHOCK(SkillProgression.Skill.DESTRUCTION, "Augmented Shock", req(30, 60),
            "destruction_novice_destruction"),
    DESTRUCTION_DISINTEGRATE(SkillProgression.Skill.DESTRUCTION, "Disintegrate", req(70),
            "destruction_augmented_shock"),
    DESTRUCTION_DESTRUCTION_DUAL_CASTING(SkillProgression.Skill.DESTRUCTION, "Destruction Dual Casting", req(20),
            "destruction_novice_destruction"),
    DESTRUCTION_IMPACT(SkillProgression.Skill.DESTRUCTION, "Impact", req(40),
            "destruction_destruction_dual_casting"),

    ILLUSION_NOVICE_ILLUSION(SkillProgression.Skill.ILLUSION, "Novice Illusion", req(0)),
    ILLUSION_ANIMAGE(SkillProgression.Skill.ILLUSION, "Animage", req(20),
            "illusion_novice_illusion"),
    ILLUSION_KINDRED_MAGE(SkillProgression.Skill.ILLUSION, "Kindred Mage", req(40),
            "illusion_animage"),
    ILLUSION_QUIET_CASTING(SkillProgression.Skill.ILLUSION, "Quiet Casting", req(50),
            "illusion_kindred_mage"),
    ILLUSION_APPRENTICE_ILLUSION(SkillProgression.Skill.ILLUSION, "Apprentice Illusion", req(25),
            "illusion_novice_illusion"),
    ILLUSION_ADEPT_ILLUSION(SkillProgression.Skill.ILLUSION, "Adept Illusion", req(50),
            "illusion_apprentice_illusion"),
    ILLUSION_EXPERT_ILLUSION(SkillProgression.Skill.ILLUSION, "Expert Illusion", req(75),
            "illusion_adept_illusion"),
    ILLUSION_MASTER_ILLUSION(SkillProgression.Skill.ILLUSION, "Master Illusion", req(100),
            "illusion_expert_illusion"),
    ILLUSION_HYPNOTIC_GAZE(SkillProgression.Skill.ILLUSION, "Hypnotic Gaze", req(30),
            "illusion_novice_illusion"),
    ILLUSION_ASPECT_OF_TERROR(SkillProgression.Skill.ILLUSION, "Aspect of Terror", req(50),
            "illusion_hypnotic_gaze"),
    ILLUSION_RAGE(SkillProgression.Skill.ILLUSION, "Rage", req(70),
            "illusion_aspect_of_terror"),
    ILLUSION_MASTER_OF_THE_MIND(SkillProgression.Skill.ILLUSION, "Master of the Mind", req(90),
            "illusion_quiet_casting", "illusion_rage"),
    ILLUSION_ILLUSION_DUAL_CASTING(SkillProgression.Skill.ILLUSION, "Illusion Dual Casting", req(20),
            "illusion_novice_illusion"),

    RESTORATION_NOVICE_RESTORATION(SkillProgression.Skill.RESTORATION, "Novice Restoration", req(0)),
    RESTORATION_APPRENTICE_RESTORATION(SkillProgression.Skill.RESTORATION, "Apprentice Restoration", req(25),
            "restoration_novice_restoration"),
    RESTORATION_ADEPT_RESTORATION(SkillProgression.Skill.RESTORATION, "Adept Restoration", req(50),
            "restoration_apprentice_restoration"),
    RESTORATION_EXPERT_RESTORATION(SkillProgression.Skill.RESTORATION, "Expert Restoration", req(75),
            "restoration_adept_restoration"),
    RESTORATION_MASTER_RESTORATION(SkillProgression.Skill.RESTORATION, "Master Restoration", req(100),
            "restoration_expert_restoration"),
    RESTORATION_RECOVERY(SkillProgression.Skill.RESTORATION, "Recovery", req(30, 60),
            "restoration_novice_restoration"),
    RESTORATION_AVOID_DEATH(SkillProgression.Skill.RESTORATION, "Avoid Death", req(90),
            "restoration_recovery"),
    RESTORATION_REGENERATION(SkillProgression.Skill.RESTORATION, "Regeneration", req(20),
            "restoration_novice_restoration"),
    RESTORATION_NECROMAGE(SkillProgression.Skill.RESTORATION, "Necromage", req(70),
            "restoration_regeneration"),
    RESTORATION_RESPITE(SkillProgression.Skill.RESTORATION, "Respite", req(40),
            "restoration_novice_restoration"),
    RESTORATION_RESTORATION_DUAL_CASTING(SkillProgression.Skill.RESTORATION, "Restoration Dual Casting", req(20),
            "restoration_novice_restoration"),
    RESTORATION_WARD_ABSORB(SkillProgression.Skill.RESTORATION, "Ward Absorb", req(60),
            "restoration_novice_restoration");
